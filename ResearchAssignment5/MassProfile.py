...
class MassProfile:
    ...
    def MassEnclosed(self, type, radius):
        COM = CenterOfMass2(self.filename, 2) #calculate center of Mass
        ...
        #This version of mass profile returns the time, so it can be passed into the txt files
        return mIndex, COM.time.value 
